...
<head>
    ...
    <link rel="stylesheet" href="spinner.css?v=<?=$rand?>">
...
<header>
    <div class="container">
        <p class="lead ">
            Your <b>ZioX.win</b> disposable mailbox is ready.
        </p>
        <div class="row" id="address-box-normal">
            ...
            <div class="col get-new-address-col">
                ...
                <button type="button" class="btn btn-outline-dark"
                    ...
                    <i class="fas fa-magic"></i> Edit address
                </button>
            </div>
        </div>
        ...
        <form class="collapse change-address-toggle" id="address-box-edit" action="?action=redirect" method="post">
            <div class="card">
                <div class="card-body">
                    Create your own public email address:
...
<footer>
    <div class="container">
        ...
        <p>
            <small>Modded by
                <a href="https://somik.org/"><strong>Somik.org</strong></a>
            </small>
        </p>
    </div>
</footer>
