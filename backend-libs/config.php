...
$config['imap']['url'] = '{mail.example.com:993/imap/ssl/novalidate-cert}INBOX';
$config['imap']['username'] = "AllInOneMailbox@example.com";
$config['imap']['password'] = "TopSecretPa$$word";
...
$config['domains'] = array('example.com');
